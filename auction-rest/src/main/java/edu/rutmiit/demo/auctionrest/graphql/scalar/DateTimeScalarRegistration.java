package edu.rutmiit.demo.auctionrest.graphql.scalar;
 ...
 * BigDecimal маппится на java.math.BigDecimal.
 *
...
public class DateTimeScalarRegistration {
    ...
    /**
     * Регистрируем скаляры DateTime, Date и BigDecimal в runtime wiring.
     *
